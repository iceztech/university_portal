...
class View extends Display
{
    ...
    public static function render($view, $data, $sideNav = true, $header = true, $footer = true) {
        ...
        }else if($viewPath[0] == 'lecturers') {
            include VIEWS_PATH . DS .'lecturers/base/app.php';
        }else if($viewPath[0] == 'students') {
            include VIEWS_PATH . DS .'students/base/app.php';
        }else if($viewPath[0] == 'utme') {
            include VIEWS_PATH . DS .'utme/base/app.php';
        }
        parent::formError();
