                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class=" form-group ml-8 mt-3">
                                                    <input type="text" name="continuous_assessment_score[]" value="<?=displayObj($course, 'rc_continuous_assessment_score')?>" id="continuous_assessment_score" placeholder="" class="form-control">
                                                    <small class="continuous_assessment_score-e"></small>
                                                </div>
                                            </td>
                                            <td>
                                                <div class=" form-group ml-8 mt-3">
                                                    <input type="text" name="exam_score[]" id="exam_score" value="<?=displayObj($course, 'rc_exam_score')?>" placeholder="" class="form-control">
