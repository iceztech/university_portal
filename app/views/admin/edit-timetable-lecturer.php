        <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post" action="<?=SR. "/admin/update-timetable-lecturer/{$timetable->id}/{$lecturers->id}"?>">
                            <div class="row">
                                ...
                                <div class="col-12 pt-4 pb-3">
                                    <div class="row">
                                            <div class="col-lg-4 col-12 form-group">
                                                ...
                                                <input name="lecturers" value="<?= displayObj($lecturers,'lecturers') ?>"  type="text" placeholder="" class="form-control" >
                                            </div>
                                    </div>
                                </div>
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" class="btn-fill-sm btn-gradient-yellow btn-hover-bluedark">Save</button>
                                   <a href="<?=SR."/admin/delete-timetable-lecturer/{$lecturers->id}"?>">
