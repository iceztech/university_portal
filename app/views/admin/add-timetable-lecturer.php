        <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post" action="<?=SR. "/admin/store-timetable-lecturer/{$timetable->id}"?>">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-12 form-group">
                                    <label>Day</label>
                                    <select disabled name="day" class="select2">
                                        <option value="">Please Select *</option>
                                ...
                                <div class="col-12 pt-4 pb-3">
                                    <div class="row">
                                        <?php if ($lecturers == null):?>
                                            <div class="col-lg-4 col-12 form-group">
                                                <label>Lecturer 1</label>
                                                <input name="lecturers[]" value=""  type="text" placeholder="" class="form-control" >
                                            </div>
                                            <div class="col-lg-4 col-12 form-group">
                                                <label>Lecturer 2</label>
                                                <input name="lecturers[]" value=""  type="text" placeholder="" class="form-control" >
                                            </div>
                                            <div class="col-lg-4 col-12 form-group">
                                                <label>Lecturer 3</label>
                                                <input name="lecturers[]" value=""  type="text" placeholder="" class="form-control" >
                                            </div>
                                            <div class="col-lg-4 col-12 form-group">
                                                <label>Lecturer 4</label>
                                                <input name="lecturers[]" value=""  type="text" placeholder="" class="form-control" >
                                            </div>
                                            <div class="col-lg-4 col-12 form-group">
                                                <label>Lecturer 5</label>
                                                <input name="lecturers[]" value=""  type="text" placeholder="" class="form-control" >
                                            </div>
                                        <?php endif;?>
                                        <?php $sn = 0; foreach ($lecturers as $lecturer):?>
                                            <div class="col-lg-4 col-12 form-group">
                                                <label>Lecturer <?= ++$sn ?></label>
                                                <input disabled value="<?= $lecturer->lecturers ?>"  type="text" placeholder="" class="form-control" >
                                            </div>
                                        <?php endforeach;?>
                                        <div class="col-lg-4 col-12 form-group">
                                            <label>Add More Lecturers</label>
                                            <input name="lecturers[]" value=""  type="text" placeholder="" class="form-control" >
                                        </div>
                                        <div class="col-lg-4 col-12 form-group">
                                            <label>Add More Lecturers</label>
                                ...
                                <div class="card-body">
                                    <div class="heading-layout1">
                                        <div class="item-title pb-3">
                                            <h3 class="text-center">Lecturers Handling Course</h3>
                                        </div>
                                        ...
                                        <table class="table display data-table text-nowrap">
                                            ...
                                            <?php $sn = 0; foreach ($lecturers as $lecturer) :?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><label class="form-check-label"><?= $lecturer->lecturers?></label></td>
                                                        <td>
                                                            <div class=" form-group ml-8 mt-3">
                                                                <a href='<?=SR."/admin/edit-timetable-lecturer/{$timetable->id}/{$lecturer->id}"?>'>
                                                                    <button type="submit" class="btn-fill-sm btn-gradient-yellow btn-hover-bluedark">Edit</button>
                                                                </a>
                                                                <a href='<?=SR."/admin/delete-timetable-lecturer/{$lecturer->id}"?>'>
