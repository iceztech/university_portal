    ...
    <div class="login-page-wrap">
        <div class="login-page-content">
            <div class="login-box">
                ...
                <form action="<?=SR."/login/loginPUTME"?>" method="post" class="login-form">
                    <div class="form-group">
                        <label>Registration Number</label>
                        <input type="text" placeholder="Enter Jamb Reg number or email" name="username" class="form-control">
